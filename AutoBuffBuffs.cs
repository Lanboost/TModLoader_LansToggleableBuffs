...
namespace AutoBuff
{
    public class BuffValue
    {
        ...
        public BuffValue(bool isMainGame, int id, string name, string effect, string mod, CostValue[] cost, BuffFunction func, bool useMainBuff)
        {
    ...
    public class ItemCostValue: CostValue
    {
        ...
        public ItemCostValue(int itemid, int count)
        {
            this.itemid = itemid;
            this.count = count;
        }
